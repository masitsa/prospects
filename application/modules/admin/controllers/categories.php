...
class Categories extends admin 
{
	...
	function __construct()
	{
		...
		$this->categories_path = realpath(APPPATH . '../assets/categories');
		$this->categories_location = base_url().'/assets/categories/';
	}
	...
	*/
	public function edit_category($category_id) 
	{
		...
		if ($this->form_validation->run())
		{
			...
			{
				$categories_path = $this->categories_path;
				$categories_location = $this->categories_location;
				
				//delete original image
				$this->file_model->delete_file($categories_path."\\".$this->input->post('current_image'), $categories_location);
				
				//delete original thumbnail
				$this->file_model->delete_file($categories_path."\\thumbnail_".$this->input->post('current_image'), $categories_location);
				/*
				/*
					-----------------------------------------------------------------------------------------
					Upload image
