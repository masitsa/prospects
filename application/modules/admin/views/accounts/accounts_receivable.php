		...
		if ($query->num_rows() > 0)
		{
			...
			<table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>#</th>
						<th><a href="'.site_url().'admin/accounts-receivable/order_created/'.$order_method.'/'.$page.'">Order date</a></th>
						<th><a href="'.site_url().'admin/accounts-receivable/order_number/'.$order_method.'/'.$page.'">Order number</a></th>
						<th><a href="'.site_url().'admin/accounts-receivable/customer_first_name/'.$order_method.'/'.$page.'">Customer</a></th>
						<th><a href="'.site_url().'admin/accounts-receivable/dobi_first_name/'.$order_method.'/'.$page.'">Dobi</a></th>
						<th><a href="'.site_url().'admin/accounts-receivable/orders.payment_method_id/'.$order_method.'/'.$page.'">Payment method</a></th>
						<th><a href="'.site_url().'admin/accounts-receivable/orders.order_status_id/'.$order_method.'/'.$page.'">Status</a></th>
						<th>Total items</th>
						<th>Amount</th>
						<th>Fold</th>
						<th>Iron</th>
						<th>Delivery</th>
						<th>Minimal Charge</th>
						<th>Total</th>
						<th >Actions</th>
					</tr>
				</thead>
			...
			foreach ($query->result() as $row)
			{
				...
				'
					<tr>
						...
						<td><a href="'.site_url().'admin/confirm-payment/'.$order_id.'/'.$order_number.'/'.$order.'/'.$order_method.'/'.$page.'" class="btn btn-sm btn-success" title="Confirm payment"><i class="fa fa-pencil" onclick="return confirm(\'Do you really want to confirm the payment for order number '.$order_number.'?\');"></i></a></td>
					</tr> 
				';
			}
...
?>
                                ...
                                <section class="panel panel-featured-left panel-featured-secondary">
                                    <div class="panel-body">
                                        <div class="widget-summary">
                                            ...
                                            <div class="widget-summary-col">
                                                <div class="summary">
                                                    <h4 class="title">Receivable</h4>
                                                    <div class="info">
                                                        <strong class="amount">Kes <?php echo number_format($total_receivable, 2);?></strong>
                                                    </div>
                                                </div>
                                                <div class="summary-footer">
                                                </div>
						...
						<section class="panel">
							...
							<div class="panel-body">
                                ...
                                <?php echo form_open('admin/search-accounts-receivable');?>
								...
								else
								{
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="<?php echo site_url().'admin/close-receivable-search';?>" class="btn btn-info">Close search</a>
                                        </div>
                                    </div>
                                    <?php
								}
