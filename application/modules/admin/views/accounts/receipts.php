		...
		if ($query->num_rows() > 0)
		{
			...
			<table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>#</th>
						<th><a href="'.site_url().'admin/receipts/order_created/'.$order_method.'/'.$page.'">Order date</a></th>
						<th><a href="'.site_url().'admin/receipts/order_number/'.$order_method.'/'.$page.'">Order number</a></th>
						<th><a href="'.site_url().'admin/receipts/dobi_first_name/'.$order_method.'/'.$page.'">Dobi</a></th>
						<th><a href="'.site_url().'admin/receipts/orders.payment_method_id/'.$order_method.'/'.$page.'">Payment method</a></th>
						<th><a href="'.site_url().'admin/receipts/orders.order_status_id/'.$order_method.'/'.$page.'">Status</a></th>
						<th>Total items</th>
						<th>Pay to Dobi</th>
						<th>Pay to Me</th>
						<th>Total</th>
...
?>
						...
						<section class="panel">
							...
							<div class="panel-body">
                                ...
                                <?php echo form_open('admin/search-receipts');?>
								...
								else
								{
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="<?php echo site_url().'admin/close-receipts-search';?>" class="btn btn-info">Close search</a>
                                        </div>
                                    </div>
                                    <?php
								}
