<section class="panel">
    <header class="panel-heading">
        ...
        <a href="<?php echo site_url().'administration/add-gallery';?>" class="btn btn-success btn-sm pull-right" style="margin-top:-25px;">Add Gallery</a>
    </header>
		...
		<?php	
				...
				if ($query->num_rows() > 0)
				{
						...
						foreach($query->result() as $cat){
							...
							$gallery_image_name = 'thumb_'.$cat->gallery_image_name;
							$count++;
