<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">All Services</h2>
         <a href="<?php echo site_url().'administration/add-service';?>" class="btn btn-success btn-sm pull-right" style="margin-top:-25px;">Add Service</a>
    </header>
		...
		<?php	
				...
				if ($query->num_rows() > 0)
				{
						...
						foreach($query->result() as $cat){
							...
							$service_image_name = 'thumb_'.$cat->service_image_name;
							$count++;
