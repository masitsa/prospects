	<section class="panel panel-featured panel-featured-info">
        <header class="panel-heading">
            <h2 class="panel-title">Total clicks for the last 7 days</h2>
        </header>   
...
var url = config_url+"site/charts/get_click_totals/"+current_timestamp;
...
for(r = 0; r < 8; r++)
{
	$.ajax({
		...
		success:function(data){
			...
			ios.push([current_timestamp, data.ios]);
			android.push([current_timestamp, data.android]);
			windows.push([current_timestamp, data.windows]);
			
			current_timestamp = current_timestamp - 86400000;
			url = config_url+"site/charts/get_click_totals/"+current_timestamp;
		},
